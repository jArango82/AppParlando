...
class _ProfileScreenState extends State<ProfileScreen> {
          ...
          children: [
                ...
                children: [
                  Container(
                    ...
                    child: CircleAvatar(
                      ...
                      child:
                          (_localImageFile == null && user['imageUrl'] == null)
                              ? Text(
                                  fullName.isNotEmpty
            ...
            _buildInfoCard([
              _buildInfoRow(Icons.badge, 'Documento',
                  document.isEmpty ? 'N/A' : document),
              _buildInfoRow(
                  Icons.cake, 'Nacimiento', fDate(user['dateOfBirth'])),
              _buildInfoRow(
                  Icons.person, 'Acudiente', user['guardianName'] ?? 'N/A'),
              _buildInfoRow(
                  Icons.phone, 'Contacto', user['contactNumber'] ?? 'N/A'),
            ]),
            ...
            _buildInfoCard([
              _buildInfoRow(
                  Icons.school, 'Tipo de Curso', user['courseType'] ?? 'N/A'),
              _buildInfoRow(Icons.calendar_today, 'Inicio Contrato',
                  fDate(user['startDate'])),
              _buildInfoRow(
                  Icons.event_busy, 'Fin Contrato', fDate(user['endDate'])),
  ...
  Widget _buildFinancialCard(
      Map<String, dynamic> user, String Function(dynamic) fMoney) {
      ...
      decoration: BoxDecoration(
        gradient: const LinearGradient(
          colors: [
            Color(0xFF2A60E4),
            Color(0xFF1FAB5E)
          ], // Gradiente de Azul a Verde (Colores de marca)
      ...
      child: Column(
        ...
        children: [
          ...
          if (user['computed_payment_status'] != null) ...[
              ...
              if (totalQ > 0) {
                return Column(
                  ...
                  children: [
                    ...
                    Text('Cuotas: $paid de $totalQ pagadas',
                        style: const TextStyle(
                            color: Colors.white,
                            fontSize: 13,
                            fontWeight: FontWeight.w500)),
            ...
            const Text('Pago a cuotas activo',
  ...
  Widget _buildLevelBadge(String level, Color color) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color:
              hasBadge ? color.withOpacity(0.3) : Colors.grey.withOpacity(0.15),
          width: 1.5,
        ),
        boxShadow: hasBadge
            ? [
